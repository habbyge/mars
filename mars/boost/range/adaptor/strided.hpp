...
class strided_iterator
    : public iterator_facade<
        strided_iterator<BaseIterator, Category>, typename iterator_value<BaseIterator>::type, forward_traversal_tag, typename iterator_reference<BaseIterator>::type, typename iterator_difference<BaseIterator>::type
    > {
...
public:
  ...
  strided_iterator()
      : m_it(), m_last(), m_stride() {
  }

  strided_iterator(base_iterator it,
                   base_iterator last,
                   difference_type stride)
      : m_it(it), m_last(last), m_stride(stride) {
  }
  ...
  strided_iterator(
      ...
      : m_it(other.base()), m_last(other.base_end()), m_stride(other.get_stride()) {
  }
...
class strided_iterator<BaseIterator, bidirectional_traversal_tag>
    : public iterator_facade<
        strided_iterator<BaseIterator, bidirectional_traversal_tag>, typename iterator_value<BaseIterator>::type, bidirectional_traversal_tag, typename iterator_reference<BaseIterator>::type, typename iterator_difference<BaseIterator>::type
    > {
  friend class ::boost::iterator_core_access;
...
public:
  ...
  strided_iterator()
      : m_it(), m_offset(), m_index(), m_stride() {
  }

  strided_iterator(base_iterator it,
                   size_type index,
                   difference_type stride)
      : m_it(it), m_offset(), m_index(index), m_stride(stride) {
  ...
  strided_iterator(
      ...
      : m_it(other.base()), m_offset(other.get_offset()), m_index(other.get_index()), m_stride(other.get_stride()) {
  }
...
class strided_iterator<BaseIterator, random_access_traversal_tag>
    : public iterator_facade<
        strided_iterator<BaseIterator, random_access_traversal_tag>, typename iterator_value<BaseIterator>::type, random_access_traversal_tag, typename iterator_reference<BaseIterator>::type, typename iterator_difference<BaseIterator>::type
    > {
  friend class ::boost::iterator_core_access;
...
public:
  ...
  strided_iterator()
      : m_it(), m_first(), m_index(0), m_stride() {
  }
  ...
  strided_iterator(
      ...
      : m_it(it), m_first(first), m_index(stride ? (it - first) : difference_type()), m_stride(stride) {
    if (stride && ((m_index % stride) != 0))
      m_index += (stride - (m_index % stride));
  }
  ...
  strided_iterator(
      ...
      : m_it(other.base()), m_first(other.base_begin()), m_index(other.get_index()), m_stride(other.get_stride()) {
  }
