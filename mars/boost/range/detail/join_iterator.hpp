...
template<typename Iterator1, typename Iterator2, typename Reference
>
...
public:
  ...
  join_iterator_union(unsigned int /*selected*/, const iterator1_t& it1, const iterator2_t& it2) : m_it1(it1),
                                                                                                   m_it2(it2) {}
...
template<typename Iterator1, typename Iterator2, typename ValueType = typename iterator_value<Iterator1>::type
    ...
    , typename Reference = typename mpl::if_c<
        ...
        typename mpl::if_c<
            ...
            typename iterator_reference<Iterator1>::type
        >::type
    >::type, typename Traversal = typename demote_iterator_traversal_tag<
        typename iterator_traversal<Iterator1>::type, typename iterator_traversal<Iterator2>::type>::type
>
class join_iterator
...
public:
  ...
  join_iterator()
      : m_section(0u), m_it(0u, iterator1_t(), iterator2_t()), m_link(link_t(iterator1_t(), iterator2_t())) {}

  join_iterator(unsigned int section, Iterator1 current1, Iterator1 last1, Iterator2 first2, Iterator2 current2)
      : m_section(section), m_it(section, current1, current2), m_link(link_t(last1, first2)) {
  }
  ...
  join_iterator(Range1& r1, Range2& r2, join_iterator_end_tag)
      : m_section(1u), m_it(1u, mars_boost::end(r1), mars_boost::end(r2)),
        m_link(link_t(mars_boost::end(r1), mars_boost::begin(r2))) {
  }

  template<typename Range1, typename Range2>
  join_iterator(const Range1& r1, const Range2& r2, join_iterator_end_tag)
      : m_section(1u), m_it(1u, mars_boost::const_end(r1), mars_boost::const_end(r2)),
        m_link(link_t(mars_boost::const_end(r1), mars_boost::const_begin(r2))) {
  }
