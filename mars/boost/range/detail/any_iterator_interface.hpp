...
template<
    class Reference, class Difference, class Buffer
>
...
template<
    class Traversal, class Reference, class Difference, class Buffer
>
...
>
struct any_iterator_interface_type_generator<
    incrementable_traversal_tag, Reference, Difference, Buffer
> {
...
>
struct any_iterator_interface_type_generator<
    single_pass_traversal_tag, Reference, Difference, Buffer
> {
...
>
struct any_iterator_interface_type_generator<
    forward_traversal_tag, Reference, Difference, Buffer
> {
...
>
struct any_iterator_interface_type_generator<
    bidirectional_traversal_tag, Reference, Difference, Buffer
> {
...
>
struct any_iterator_interface_type_generator<
    random_access_traversal_tag, Reference, Difference, Buffer
> {
