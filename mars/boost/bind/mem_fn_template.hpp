...
template<class R, class T BOOST_MEM_FN_CLASS_F>
...
template<class R, class T, class A1 BOOST_MEM_FN_CLASS_F>
...
template<class R, class T, class A1, class A2 BOOST_MEM_FN_CLASS_F>
...
template<class R, class T, class A1, class A2, class A3, class A4 BOOST_MEM_FN_CLASS_F>
...
template<class R, class T, class A1, class A2, class A3, class A4, class A5 BOOST_MEM_FN_CLASS_F>
...
template<class R, class T, class A1, class A2, class A3, class A4, class A5, class A6 BOOST_MEM_FN_CLASS_F>
...
template<class R, class T, class A1, class A2, class A3, class A4, class A5, class A6, class A7 BOOST_MEM_FN_CLASS_F>
...
template<class R, class T, class A1, class A2, class A3, class A4, class A5, class A6, class A7, class A8 BOOST_MEM_FN_CLASS_F>
