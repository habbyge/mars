...
class rv
    : public ::mars_boost::move_detail::if_c
        <::mars_boost::move_detail::is_class<T>::value, T, ::mars_boost::move_detail::nat
        >::type {
  rv();
...
inline typename ::mars_boost::move_detail::enable_if_c
    <::mars_boost::move_detail::is_lvalue_reference<Ret>::value ||
     !::mars_boost::has_move_emulation_enabled<T>::value, T&>::type
...
inline typename ::mars_boost::move_detail::enable_if_c
    <!::mars_boost::move_detail::is_lvalue_reference<Ret>::value &&
     ::mars_boost::has_move_emulation_enabled<T>::value, ::mars_boost::rv<T>&>::type
move_return(T& x) BOOST_NOEXCEPT {
