...
inline typename ::mars_boost::move_detail::enable_if_and
    <T&, enable_move_utility_emulation<T>, has_move_emulation_disabled<T>
    >::type
...
template<class T>
inline typename ::mars_boost::move_detail::enable_if_and
    <rv<T>&, enable_move_utility_emulation<T>, has_move_emulation_enabled<T>
    >::type
move(T& x) BOOST_NOEXCEPT {
...
template<class T>
inline typename ::mars_boost::move_detail::enable_if_and
    <T&, enable_move_utility_emulation<T>, ::mars_boost::move_detail::is_rv<T>
    >::type
...
template<class T>
inline typename ::mars_boost::move_detail::enable_if_and
    <const T&, enable_move_utility_emulation<T>, ::mars_boost::move_detail::is_not_rv<T>
    >::type
forward(const typename ::mars_boost::move_detail::identity<T>::type& x) BOOST_NOEXCEPT {
  return x;
}
...
template<class T>
inline typename ::mars_boost::move_detail::enable_if_and
    <typename ::mars_boost::move_detail::add_lvalue_reference<T>::type, enable_move_utility_emulation<T>, ::mars_boost::move_detail::is_not_rv<T>, ::mars_boost::move_detail::or_
        <::mars_boost::move_detail::is_lvalue_reference<T>, has_move_emulation_disabled<T>
        >
    >::type
...
template<class T>
inline typename ::mars_boost::move_detail::enable_if_and
    <rv<T>&, enable_move_utility_emulation<T>, ::mars_boost::move_detail::is_not_rv<T>, ::mars_boost::move_detail::and_
        <::mars_boost::move_detail::not_<::mars_boost::move_detail::is_lvalue_reference<T>>, has_move_emulation_enabled<T>
        >
    >::type
move_if_not_lvalue_reference(typename ::mars_boost::move_detail::remove_reference<T>::type& x) BOOST_NOEXCEPT {
  return move(x);
