...
public:
  ...
  typedef typename ::mars_boost::move_detail::if_
      <::mars_boost::has_move_emulation_enabled<value_type>, ::mars_boost::rv<value_type>&, value_type&>::type reference;
#endif
  typedef It pointer;
  ...
  move_iterator<iterator_type> operator+(difference_type n) const { return move_iterator<iterator_type>(m_it + n); }
...
template<class It>
inline move_iterator<It> make_move_iterator(const It& it) { return move_iterator<It>(it); }
...
public:
  ...
  back_move_insert_iterator& operator=(reference x) {
    container_m->push_back(mars_boost::move(x));
    return *this;
  }
...
public:
  ...
  front_move_insert_iterator& operator=(reference x) {
    container_m->push_front(mars_boost::move(x));
    return *this;
  }
