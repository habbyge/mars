...
template<
    typename C, typename T1, typename T2
>
struct eval_if
    : if_<C, T1, T2>::type {
};
...
template<class T, bool emulation = has_move_emulation_enabled_impl<T>::value, bool rv = is_rv_impl<T>::value>
