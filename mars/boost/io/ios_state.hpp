...
public:
  ...
  ~ios_precision_saver() { this->restore(); }

  void restore() { s_save_.precision(a_save_); }
...
public:
  ...
  void restore() { s_save_.width(a_save_); }
...
public:
  ...
  basic_ios_iostate_saver(state_type& s, aspect_type const& a)
      : s_save_(s), a_save_(s.rdstate()) { s.clear(a); }

  ~basic_ios_iostate_saver() { this->restore(); }

  void restore() { s_save_.clear(a_save_); }
...
#endif
      : s_save_(s), a_save_(s.exceptions()) { s.exceptions(a); }

  ~basic_ios_exception_saver() { this->restore(); }

  void restore() { s_save_.exceptions(a_save_); }
...
public:
  ...
  ~basic_ios_tie_saver() { this->restore(); }
...
public:
  ...
  ~basic_ios_rdbuf_saver() { this->restore(); }

  void restore() { s_save_.rdbuf(a_save_); }
...
public:
  ...
  ~basic_ios_fill_saver() { this->restore(); }

  void restore() { s_save_.fill(a_save_); }
...
public:
  ...
  ios_iword_saver(state_type& s, index_type i, aspect_type const& a)
      : s_save_(s), a_save_(s.iword(i)), i_save_(i) { s.iword(i) = a; }

  ~ios_iword_saver() { this->restore(); }

  void restore() { s_save_.iword(i_save_) = a_save_; }
...
public:
  ...
  ios_pword_saver(state_type& s, index_type i, aspect_type const& a)
      : s_save_(s), a_save_(s.pword(i)), i_save_(i) { s.pword(i) = a; }

  ~ios_pword_saver() { this->restore(); }

  void restore() { s_save_.pword(i_save_) = a_save_; }
...
public:
  ...
  ~basic_ios_all_saver() { this->restore(); }
