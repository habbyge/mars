...
void
testFunc(TestCaseInfo* m_testCaseInfo, NetType netType, bool isUserNameEmpty, int activeState, ActiveLogic& activeLogic,
         BaseScene& baseScene, unsigned long expectInterval) {
  Hook();
  sg_NetInfo = netType;
...
{
m_testCaseInfo->
m_TestCaseName = "(ENoNet, No AccountInfo, EForgroundActive)";
...
testFunc(m_testCaseInfo, kNoNet,
true, EForgroundActive, activeLogic, baseScene, expectInterval);
}
...
{
m_testCaseInfo->
m_TestCaseName = "(ENoNet, No AccountInfo, EInactive)";
//net, accountInfo , activeState
BaseScene baseScene;
ActiveLogic activeLogic;
...
testFunc(m_testCaseInfo, kNoNet,
true, EInactive, activeLogic, baseScene, expectInterval);
}
...
{
m_testCaseInfo->
m_TestCaseName = "(ENoNet, No AccountInfo, EForgroundOneMinute)";
//net, accountInfo , activeState
BaseScene baseScene;
ActiveLogic activeLogic;
...
testFunc(m_testCaseInfo, kNoNet,
true, EForgroundOneMinute, activeLogic, baseScene, expectInterval);
...
{
m_testCaseInfo->
m_TestCaseName = "(ENoNet, No AccountInfo, EForgroundTenMinute)";
//net, accountInfo , activeState
BaseScene baseScene;
ActiveLogic activeLogic;
...
testFunc(m_testCaseInfo, kNoNet,
true, EForgroundTenMinute, activeLogic, baseScene, expectInterval);
...
{
m_testCaseInfo->
m_TestCaseName = "(ENoNet, No AccountInfo, EBackgroundActive)";
//net, accountInfo , activeState
BaseScene baseScene;
ActiveLogic activeLogic;
...
testFunc(m_testCaseInfo, kNoNet,
true, EBackgroundActive, activeLogic, baseScene, expectInterval);
...
{
m_testCaseInfo->
m_TestCaseName = "(EWifi, No AccountInfo, EForgroundActive)";
//net, accountInfo , activeState
BaseScene baseScene;
ActiveLogic activeLogic;
...
{
m_testCaseInfo->
m_TestCaseName = "(EWifi, No AccountInfo, EInactive)";
//net, accountInfo , activeState
BaseScene baseScene;
ActiveLogic activeLogic;
...
{
m_testCaseInfo->
m_TestCaseName = "(EWifi, No AccountInfo, EForgroundOneMinute)";
//net, accountInfo , activeState
BaseScene baseScene;
ActiveLogic activeLogic;
...
{
m_testCaseInfo->
m_TestCaseName = "(EWifi, No AccountInfo, EForgroundTenMinute)";
//net, accountInfo , activeState
BaseScene baseScene;
ActiveLogic activeLogic;
...
{
m_testCaseInfo->
m_TestCaseName = "(EWifi, No AccountInfo, EBackgroundActive)";
//net, accountInfo , activeState
BaseScene baseScene;
ActiveLogic activeLogic;
...
{
m_testCaseInfo->
m_TestCaseName = "(EWifi, Have AccountInfo, EForgroundActive)";
//net, accountInfo , activeState
BaseScene baseScene;
ActiveLogic activeLogic;
...
testFunc(m_testCaseInfo, kWifi,
false, EForgroundActive, activeLogic, baseScene, expectInterval);
}
...
{
m_testCaseInfo->
m_TestCaseName = "(EWifi, Have AccountInfo, EInactive)";
//net, accountInfo , activeState
BaseScene baseScene;
ActiveLogic activeLogic;
...
testFunc(m_testCaseInfo, kWifi,
false, EInactive, activeLogic, baseScene, expectInterval);
...
{
m_testCaseInfo->
m_TestCaseName = "(EWifi, Have AccountInfo, EForgroundOneMinute)";
//net, accountInfo , activeState
BaseScene baseScene;
ActiveLogic activeLogic;
...
unsigned long expectInterval = 15;
testFunc(m_testCaseInfo, kWifi,
false, EForgroundOneMinute, activeLogic, baseScene, expectInterval);
...
{
m_testCaseInfo->
m_TestCaseName = "(EWifi, Have AccountInfo, EForgroundTenMinute)";
//net, accountInfo , activeState
BaseScene baseScene;
ActiveLogic activeLogic;
...
unsigned long expectInterval = 30;
testFunc(m_testCaseInfo, kWifi,
false, EForgroundTenMinute, activeLogic, baseScene, expectInterval);
...
{
m_testCaseInfo->
m_TestCaseName = "(EWifi, Have AccountInfo, EBackgroundActive)";
//net, accountInfo , activeState
BaseScene baseScene;
ActiveLogic activeLogic;
...
unsigned long expectInterval = 300;
testFunc(m_testCaseInfo, kWifi,
false, EBackgroundActive, activeLogic, baseScene, expectInterval);
...
{
m_testCaseInfo->
m_TestCaseName = "(ENoNet, Have AccountInfo, EForgroundActive)";
//net, accountInfo , activeState
BaseScene baseScene;
ActiveLogic activeLogic;
...
{
m_testCaseInfo->
m_TestCaseName = "(ENoNet, Have AccountInfo, EInactive)";
//net, accountInfo , activeState
BaseScene baseScene;
ActiveLogic activeLogic;
...
{
m_testCaseInfo->
m_TestCaseName = "(ENoNet, Have AccountInfo, EForgroundOneMinute)";
//net, accountInfo , activeState
BaseScene baseScene;
ActiveLogic activeLogic;
...
{
m_testCaseInfo->
m_TestCaseName = "(ENoNet, Have AccountInfo, EForgroundTenMinute)";
//net, accountInfo , activeState
BaseScene baseScene;
ActiveLogic activeLogic;
...
{
m_testCaseInfo->
m_TestCaseName = "(ENoNet, Have AccountInfo, EBackgroundActive)";
//net, accountInfo , activeState
BaseScene baseScene;
ActiveLogic activeLogic;
