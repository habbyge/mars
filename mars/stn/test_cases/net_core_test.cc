...
bool (CDetour::* CDetour::Real_Target1)(std::vector<IPPortItem>& _IPPortItems) = (bool (CDetour::*)(
    std::vector<IPPortItem>& _IPPortItems)) &CMMNetSource::GetLongLinkItems;

bool (CDetour::* CDetour::Real_Target2)(std::vector<IPPortItem>& _IPPortItems) = (bool (CDetour::*)(
...
DetourAttach(& (PVOID
&)CDetour::Real_Target1, *(PBYTE*)&Mine_Target1);
DetourAttach(& (PVOID
&)CDetour::Real_Target2, *(PBYTE*)&Mine_Target2);
...
ThreadUtil::sleep(4);
EXPECT_NE(MMLongLink2::EConnectFailed, longlink
.m_connectstatus);
