...
{
m_testCaseInfo->
m_TestCaseName = "Longlink Hosts Order by Auth";
...
info1.
Origin = "long.weixin.qq.com";
info1.
Substitute = "long.weixin.qq.com";
info1.
priority = 1;
...
Origin = "long.weixin.qq.com";
info2.
Substitute = "sh2tjlong.weixin.qq.com";
info2.
priority = 2;
...
PUBC_EXPECT_EQ(longHostList
.at(0).

c_str(), highPriorityHostFromAuth, & baseScene

);
PUBC_EXPECT_EQ(longHostList
.at(1).

c_str(), lowPriorityHostFromAuth, & baseScene
...
{
m_testCaseInfo->
m_TestCaseName = "Shortlink Hosts Order by Auth";
...
struct IdcHostInfo info1;
info1.
Origin = "short.weixin.qq.com";
info1.
Substitute = "short.weixin.qq.com";
info1.
priority = 1;
...
Origin = "short.weixin.qq.com";
info2.
Substitute = "szshort.weixin.qq.com";
info2.
priority = 2;
...
CMMNetCore::Singleton()->GetNetSource().
GetDefShortLinkHost(shortHostList);
std::string HighPriorityHostFromAuth(highPriorityHostFromAuth);
std::string LowPriorityHostFromAuth(lowPriorityHostFromAuth);
baseScene.setEventName("GetDefShortLinkHost");
PUBC_EXPECT_EQ(shortHostList
.at(0).
