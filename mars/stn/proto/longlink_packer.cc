...
static int
__unpack_test(const void* _packed, size_t _packed_len, uint32_t& _cmdid, uint32_t& _seq, size_t& _package_len,
              size_t& _body_len) {
...
LongLinkEncoder::LongLinkEncoder() {
  longlink_pack = [](uint32_t _cmdid, uint32_t _seq, const AutoBuffer& _body, const AutoBuffer& _extension,
  ...
  longlink_unpack = [](const AutoBuffer& _packed, uint32_t& _cmdid, uint32_t& _seq, size_t& _package_len,
  ...
  longlink_noop_isresp = [](uint32_t _taskid, uint32_t _cmdid, uint32_t _recv_seq, const AutoBuffer& _body,
