...
#else
static const uint64_t kInactiveSpeed = (1);
static const uint64_t kActiveSpeed = (3);
static const uint64_t kInactiveMinvol = (1500);
static const uint64_t kMaxVol = (2 * 1024);
#endif
