 ...
 */
JNIEXPORT jobject
JNICALL Java_com_tencent_mars_stn_StnLogic_getLoadLibraries
...
Java_com_tencent_mars_stn_StnLogic_reset
(JNIEnv * _env , jclass clz ) {
Reset();
}
 ...
 */
DEFINE_FIND_STATIC_METHOD(KJava2C_setLonglinkSvrAddr, KNetJava2C, "setLonglinkSvrAddr",
                          "(Ljava/lang/String;[ILjava/lang/String;)V")
JNIEXPORT void JNICALL
Java_com_tencent_mars_stn_StnLogic_setLonglinkSvrAddr
(JNIEnv
*_env, jclass,
jstring _host, jintArray
_ports,
jstring _debug_ip
) {
...
++i){
ports.
push_back((uint16_t)(p_port[i])
);
}
_env->
ReleaseIntArrayElements(_ports, p_port,
0);
...
JNIEXPORT void JNICALL
Java_com_tencent_mars_stn_StnLogic_setShortlinkSvrAddr
(JNIEnv
*_env, jclass,
jint _port, jstring
_debug_ip) {
...
JNIEXPORT void JNICALL
Java_com_tencent_mars_stn_StnLogic_setDebugIP
(JNIEnv
*_env, jclass,
jstring _host, jstring
_debug_ip) {
...
JNIEXPORT void JNICALL
Java_com_tencent_mars_stn_StnLogic_setBackupIPs
(JNIEnv
*_env, jclass,
jstring _host, jobjectArray
_objarray) {
std::string host = (NULL == _host ? "" : ScopedJstring(_env, _host).GetChar());
...
jstring ip = (jstring)
_env->
GetObjectArrayElement(_objarray, i
);
if (ip != NULL) {
backupip_list.
push_back(ScopedJstring(_env, ip)
.
...
JNIEXPORT void JNICALL
Java_com_tencent_mars_stn_StnLogic_startTask
(JNIEnv
*_env, jclass,
jobject _task
) {
...
jstring cgi = (jstring)
JNU_GetField(_env, _task,
"cgi", "Ljava/lang/String;").
l;
...
jstring report_arg = (jstring)
JNU_GetField(_env, _task,
"reportArg", "Ljava/lang/String;").
l;
...
task.
network_status_sensitive = network_status_sensitive;
task.
priority = priority;
...
task.
server_process_cost = server_process_cost;
task.
total_timeout = total_timetout;
task.
headers = headers;
...
if (NULL != report_arg) {
task.
report_arg = ScopedJstring(_env, report_arg).GetChar();
}
...
i<len;
i++){
jstring host = (jstring)
_env->
CallObjectMethod(hostlist, arraylist_get, i
);
if (NULL != host) {
task.shortlink_host_list.
push_back(ScopedJstring(_env, host)
.
...
_env->
DeleteLocalRef(hostlist);
}

if (NULL != cgi) {
task.
cgi = ScopedJstring(_env, cgi).GetChar();
_env->
DeleteLocalRef(cgi);
}
...
task.
user_context = _env->NewGlobalRef(_user_context);
_env->
DeleteLocalRef(_user_context);
}
...
JNIEXPORT void JNICALL
Java_com_tencent_mars_stn_StnLogic_stopTask
(JNIEnv
*_env, jclass,
jint _taskid
) {
...
JNIEXPORT jboolean
JNICALL Java_com_tencent_mars_stn_StnLogic_hasTask
    (JNIEnv * _env, jclass, jint
_taskid) {
xverbose_function();
...
JNIEXPORT void JNICALL
Java_com_tencent_mars_stn_StnLogic_redoTask
(JNIEnv
*_env, jclass)
{
xverbose_function();
...
JNIEXPORT void JNICALL
Java_com_tencent_mars_stn_StnLogic_clearTask
(JNIEnv
*_env, jclass) {
xverbose_function();
 ...
 */
JNIEXPORT void JNICALL
Java_com_tencent_mars_stn_StnLogic_makesureLongLinkConnected
(JNIEnv
*_env, jclass) {
xverbose_function();
 ...
 */
JNIEXPORT void JNICALL
Java_com_tencent_mars_stn_StnLogic_setSignallingStrategy
(JNIEnv
*_env, jclass,
jlong _period, jlong
_keep_time) {
 ...
 */
JNIEXPORT void JNICALL
Java_com_tencent_mars_stn_StnLogic_keepSignalling
(JNIEnv
*_env, jclass) {
xverbose_function();
 ...
 */
JNIEXPORT void JNICALL
Java_com_tencent_mars_stn_StnLogic_stopSignalling
(JNIEnv
*_env, jclass) {
xverbose_function();
...
JNIEXPORT void JNICALL
Java_com_tencent_mars_stn_StnLogic_setClientVersion
(JNIEnv
*_env, jclass,
jint _client_version
) {
...
JNICALL Java_com_tencent_mars_stn_StnLogic_genTaskID
    (JNIEnv * _env, jclass) {
  return (jint)
  mars::stn::GenTaskID();
}
