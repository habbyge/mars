...
extern boost::signals2::signal<void(ErrCmdType _err_type, int _err_code, const std::string& _ip,
                                    uint16_t _port)> SignalOnLongLinkNetworkError;
extern boost::signals2::signal<void(ErrCmdType _err_type, int _err_code, const std::string& _ip,
                                    const std::string& _host, uint16_t _port)> SignalOnShortLinkNetworkError;

DEFINE_FIND_STATIC_METHOD(KC2Java_onTaskEnd, KC2Java, "onTaskEnd", "(ILjava/lang/Object;II)I")

int C2Java_OnTaskEnd(uint32_t _taskid, void* const _user_context, const std::string& _user_id, int _error_type,
                     int _error_code) {
  ...
  int ret = (int) JNU_CallStaticMethodByMethodInfo(env, KC2Java_onTaskEnd, (jint) _taskid, _user_context,
                                                   (jint) _error_type, (jint) _error_code).i;
...
void C2Java_OnPush(const std::string& _channel_id, uint32_t _cmdid, uint32_t _taskid, const AutoBuffer& _body,
  ...
  JNU_CallStaticMethodByMethodInfo(env, KC2Java_onPush, ScopedJstring(env, _channel_id.c_str()).GetJstr(),
                                   (jint) _cmdid, (jint) _taskid, data_jba);
...
std::vector<std::string> C2Java_OnNewDns(const std::string& _host) {
  ...
  if (!_host.empty()) {
    jobjectArray ip_strs = (jobjectArray) JNU_CallStaticMethodByMethodInfo(env, KC2Java_onNewDns, ScopedJstring(env,
                                                                                                                _host.c_str()).GetJstr()).l;
    if (ip_strs != NULL) {
...
DEFINE_FIND_STATIC_METHOD(KC2Java_req2Buf, KC2Java, "req2Buf",
                          "(ILjava/lang/Object;Ljava/io/ByteArrayOutputStream;[IILjava/lang/String;)Z")

bool C2Java_Req2Buf(uint32_t _taskid, void* const _user_context, const std::string& _user_id, AutoBuffer& _outbuffer,
                    AutoBuffer& _extend, int& _error_code, const int _channel_select, const std::string& _host) {
  xverbose_function();
  ...
  jboolean ret = JNU_CallStaticMethodByMethodInfo(env, KC2Java_req2Buf, (jint) _taskid, _user_context,
                                                  byte_array_output_stream_obj, errcode_array, _channel_select,
                                                  ScopedJstring(env, _host.c_str()).GetJstr()).z;

  if (ret) {
    jbyteArray ret_byte_array = (jbyteArray) JNU_CallMethodByName(env, byte_array_output_stream_obj, "toByteArray",
                                                                  "()[B").l;
...
int
C2Java_Buf2Resp(uint32_t _taskid, void* const _user_context, const std::string& _user_id, const AutoBuffer& _inbuffer,
                const AutoBuffer& _extend, int& _error_code, const int _channel_select) {
  xverbose_function();
  ...
  jint ret = JNU_CallStaticMethodByMethodInfo(env, KC2Java_buf2Resp, (jint) _taskid, _user_context, resp_buf_jba,
                                              errcode_array, _channel_select).i;
...
bool C2Java_MakesureAuthed(const std::string& _host, const std::string& _user_id) {
  ...
  jboolean ret = JNU_CallStaticMethodByMethodInfo(env, KC2Java_makesureAuthed,
                                                  ScopedJstring(env, _host.c_str()).GetJstr()).z;
...
int C2Java_GetLonglinkIdentifyCheckBuffer(const std::string& _channel_id, AutoBuffer& _identify_buffer,
  ...
  jint ret = 0;
  ret = JNU_CallStaticMethodByMethodInfo(env, KC2Java_getLongLinkIdentifyCheckBuffer,
                                         ScopedJstring(env, _channel_id.c_str()).GetJstr(), byte_array_outputstream_obj,
                                         byte_array_outputstream_hash, jcmdid_array).i;
...
DEFINE_FIND_STATIC_METHOD(KC2Java_onLongLinkIdentifyResp, KC2Java, "onLongLinkIdentifyResp",
...
bool C2Java_OnLonglinkIdentifyResponse(const std::string& _channel_id, const AutoBuffer& _response_buffer,
  ...
  jboolean ret = JNU_CallStaticMethodByMethodInfo(env, KC2Java_onLongLinkIdentifyResp,
                                                  ScopedJstring(env, _channel_id.c_str()).GetJstr(), data_jba,
                                                  hash_jba).z;
...
void C2Java_ReportConnectStatus(int _all_connstatus, int _longlink_connstatus) {
  ...
  ScopeJEnv scope_jenv(cache_instance->GetJvm());
  JNIEnv* env = scope_jenv.GetEnv();
  JNU_CallStaticMethodByMethodInfo(env, KC2Java_reportNetConnectInfo, (jint) _all_connstatus,
                                   (jint) _longlink_connstatus);
...
DEFINE_FIND_STATIC_METHOD(KC2Java_requestNetCheckShortLinkHosts, KC2Java, "requestNetCheckShortLinkHosts",
                          "()[Ljava/lang/String;")
...
void C2Java_ReportTaskProfile(const TaskProfile& _task_profile) {
  ...
  JNU_CallStaticMethodByMethodInfo(env, KC2Java_reportTaskProfile,
