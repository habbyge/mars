    ...
    if (matchLength > bestLength) {
      ...
      if ((4 * (int) (matchLength - bestLength)) >
        ...
        DEBUGLOG(9,
                 ...
                 current, (U32) bestLength, (U32) matchLength, (U32) *offsetPtr, ZSTD_REP_MOVE + current - matchIndex,
  ...
  while (ip < ilimit) {
    ...
    if (offset) {
      ...
      if (dictMode == ZSTD_dictMatchState) {
        ...
        const BYTE* match = (matchIndex < prefixLowestIndex) ? dictBase + matchIndex - dictIndexDelta : base +
                                                                                                        matchIndex;
