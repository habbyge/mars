...
static dictItem ZDICT_analyzePos(
...

  {
    ...
    DISPLAYLEVEL(4, "\n");
    DISPLAYLEVEL(4, "found %3u matches of length >= %i at pos %7u  ", (unsigned) (end - start), MINMATCHLENGTH,
                 (unsigned) pos);
    DISPLAYLEVEL(4, "\n");
...
static void ZDICT_countEStats(EStats_ress_t esr, ZSTD_parameters params,
                              unsigned* countLit, unsigned* offsetcodeCount, unsigned* matchlengthCount,
                              unsigned* litlengthCount, U32* repOffsets,
...
static size_t ZDICT_analyzeEntropy(void* dstBuffer, size_t maxDstSize,
  ...
  esr.dict = ZSTD_createCDict_advanced(dictBuffer, dictBufferSize, ZSTD_dlm_byRef, ZSTD_dct_rawContent, params.cParams,
                                       ZSTD_defaultCMem);
