...
DEFINE_FIND_STATIC_METHOD(KC2Java_reportSignalDetectResults, KC2Java, "reportSignalDetectResults",
                          "(Ljava/lang/String;)V")
...
= [](const std::vector<CheckResultProfile>& _check_results) {
  ...
  JNU_CallStaticMethodByMethodInfo(env, KC2Java_reportSignalDetectResults,
