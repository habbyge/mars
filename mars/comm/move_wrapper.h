...
public:
  static void copy_constructor(S& _lhs, S& _rhs) { _lhs = _rhs; }

  static void copy_constructor(S& _lhs, const S& _rhs) { _lhs = _rhs; }
...
public:
  ...
  move_wrapper(S& t) { copy_wrapper_helper<S>::copy_constructor(m_t, t); }

  move_wrapper(const S& t) { copy_wrapper_helper<S>::copy_constructor(m_t, t); }

  ~move_wrapper() { copy_wrapper_helper<S>::destructor(m_t); }
  ...
  move_wrapper(move_wrapper& _ref) { copy_wrapper_helper<S>::copy_constructor(m_t, _ref.m_t); }

  move_wrapper(const move_wrapper& _ref) { copy_wrapper_helper<S>::copy_constructor(m_t, _ref.m_t); }
