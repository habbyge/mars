...
WEAK_FUNC void
__xlogger_AssertP_impl(const XLoggerInfo* _info, const char* _expression, const char* _format, va_list _list);
...
extern void __ASSERTV2(const char* _pfile, int _line, const char* _pfunc, const char* _pexpression, const char* _format,
                       va_list _list);
...
extern void
__ASSERT2(const char* _pfile, int _line, const char* _pfunc, const char* _pexpression, const char* _format, ...);
